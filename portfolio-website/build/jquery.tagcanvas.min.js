 ...
 */
 (function (f) {
    ...
    for (s = 0; s < 256; ++s)
      (E = s.toString(16)),
        s < 16 && (E = "0" + E),
        (D[E] = D[E.toUpperCase()] = s.toString() + ",");
    function o(a) {
    ...
    (A = u.prototype),
      ...
      (A.unit = function () {
        var a = this.length();
        return new u(this.x / a, this.y / a, this.z / a);
      });
    function aF(b, a) {
    ...
    function aE(g, j, k, m, f) {
      var a,
        ...
        h = 2 / g,
        i;
      i = Math.PI * (3 - F(5) + (parseFloat(f) ? parseFloat(f) : 0));
      for (a = 0; a < g; ++a)
        (b = a * h - 1 + h / 2),
          (c = F(1 - b * b)),
          (d = a * i),
          e.push([l(d) * c * j, b * k, r(d) * c * m]);
      return e;
    }
    function ac(n, o, m, k, h, g) {
      var b,
        f = [],
        i = 2 / n,
        j,
        ...
        c,
        e;
      j = Math.PI * (3 - F(5) + (parseFloat(g) ? parseFloat(g) : 0));
      for (a = 0; a < n; ++a)
        (d = a * i - 1 + i / 2),
          (b = a * j),
          (c = l(b)),
          (e = r(b)),
          f.push(o ? [d * m, c * k, e * h] : [c * m, d * k, e * h]);
      return f;
    }
    function ab(k, e, f, h, i, j) {
      var b,
        g = [],
        m = (Math.PI * 2) / e,
        a,
    ...
    function aD(a, b, c, d, e) {
      return ac(a, 0, b, c, d, e);
    }
    function aC(a, b, c, d, e) {
      return ac(a, 1, b, c, d, e);
    }
    function au(b, c, d, e, a) {
      return (a = isNaN(a) ? 0 : a * 1), ab(0, b, c, d, e, a);
    }
    function aA(b, c, d, e, a) {
      return (a = isNaN(a) ? 0 : a * 1), ab(1, b, c, d, e, a);
    }
    function az(b) {
      var a = new Image();
      (a.onload = function () {
    ...
    function H(a, l, j) {
      ...
      if (a.gCanvas) (f = a.gCanvas.getContext("2d")), (d = a.gCanvas.height);
        ...
        if ((C(e[0]) ? (d = e.length) : (e = [e]), (a.gCanvas = h = m(k, d)), !h))
          return null;
        f = h.getContext("2d");
        for (b = 0; b < d; ++b) aH(f, k, b, e[b]);
      }
      return (
        (j = g(i(j || 0, d - 1), 0)),
        (c = f.getImageData(~~((k - 1) * l), j, 1, 1).data),
        "rgba(" + c[0] + "," + c[1] + "," + c[2] + "," + c[3] / 255 + ")"
      );
    }
    function Z(b, i, p, k, o, n, h, d, a, g, f, l) {
      var m = o + (d || 0) + (a.length && a[0] < 0 ? q(a[0]) : 0),
        j = n + (d || 0) + (a.length && a[1] < 0 ? q(a[1]) : 0),
        c,
        e;
      (b.font = i),
        (b.textBaseline = "top"),
    ...
    (I = T.prototype),
      (I.SetImage = function (a, b, c, d, e, f, g, h) {
        (this.image = a),
      ...
      (I.Create = function (G, D, F, b, A, l, p, j, E) {
        var o,
          e,
          f,
          a,
        ...
        return (
          ...
          this.image &&
            ...
            this.ipos == "top" || this.ipos == "bottom"
              ? (c < this.width
                  ? (x += this.Align(c, this.width, this.ialign))
                  : (w += this.Align(this.width, c, this.align)),
                this.ipos == "top"
                  ? (r += d + this.ipad)
          ...
          !o
            ...
            : ((k = h = b / 2),
              ...
              (y = i(E, s / 2, u / 2)),
              (a = o.getContext("2d")),
              D && ((a.fillStyle = D), v(a, k, h, s, u, y)),
              b &&
                ((a.strokeStyle = F), (a.lineWidth = b), v(a, k, h, s, u, y, !0)),
              (l || B || C) &&
                ((t = m(e, f)), t && ((z = a), (a = t.getContext("2d")))),
              Z(
                a,
                this.font,
                G,
              ...
              this.image && a.drawImage(this.image, x, n, c, d),
              z &&
                ((a = z),
                A && (a.shadowColor = A),
                l && (a.shadowBlur = l),
    ...
    function ai(n, u, t, e, s, c, w, d, r, x) {
      var g = u + (2 * d + c) * e,
        f = t + (2 * d + c) * e,
        k = m(g, f),
        b,
      ...
      return k
        ? ((c *= e),
          ...
          (b = k.getContext("2d")),
          (p = i(r, l / 2, j / 2)),
          s && ((b.fillStyle = s), v(b, h, q, l, j, p)),
          c && ((b.strokeStyle = w), (b.lineWidth = c), v(b, h, q, l, j, p, !0)),
          x
            ? ((o = m(g, f)),
              (a = o.getContext("2d")),
          ...
          { image: k, width: g / e, height: f / e })
        : null;
    }
    function ap(k, f, c, d, j) {
      var e,
        a,
        b = parseFloat(f),
        h = g(c, d);
          ...
          : (f.indexOf("%") > 0 ? (b = (h * b) / 100) : (b = b * j),
            ...
            b >= h / 2
              ? ((b = i(c, d) / 2),
                ...
                a.fill(),
                a.closePath())
              : ((b = i(c / 2, d / 2, b)), v(a, 0, 0, c, d, b, !0), a.fill()),
            (a.globalCompositeOperation = "source-in"),
            a.drawImage(k, 0, 0, c, d),
            e)
      );
    }
    function an(p, l, i, b, h, a, c) {
      var g = q(c[0]),
        f = q(c[1]),
        j = l + (g > a ? g + a : a * 2) * b,
        k = i + (f > a ? f + a : a * 2) * b,
      ...
      return (
        ...
        !e
          ...
          : ((d = e.getContext("2d")),
            ...
            d.drawImage(p, n, o, l, i),
            { image: e, width: j / b, height: k / b })
      );
    }
    function af(l, o, k) {
      var c = parseInt(l.toString().length * k),
        h = parseInt(k * 2 * l.length),
        j = m(c, h),
        g,
        i,
        e,
      ...
      (g = j.getContext("2d")),
        (g.fillStyle = "#000"),
        g.fillRect(0, 0, c, h),
        Z(g, k + "px " + o, "#fff", l, 0, 0, 0, 0, [], "centre"),
    ...
    function O(h, f, a, b) {
      ...
      (f.width = f.width),
        (f.height = f.height),
        k && ((h.width = f.width * k), (h.height = f.height * k)),
        (a.iw = h.width),
        (a.ih = h.height),
        b.txtOpt &&
          ((c = h),
          (g = b.zoomMax * b.txtScale),
          (e = a.iw * g),
          (d = a.ih * g),
          e < f.naturalWidth || d < f.naturalHeight
            ? ((c = P(h, e, d)), c && (a.fimage = c))
            : ((e = a.iw), (d = a.ih), (g = 1)),
          parseFloat(b.imageRadius) &&
            (a.image = a.fimage = h = ap(a.image, b.imageRadius, e, d, g)),
          a.HasText() ||
            (b.shadow &&
              ((c = an(a.image, e, d, g, b.shadow, b.shadowBlur, b.shadowOffset)),
              c && ((a.fimage = c.image), (a.w = c.width), (a.h = c.height))),
            (b.bgColour || b.bgOutlineThickness) &&
              ((i =
                b.bgColour == "tag" ? j(a.a, "background-color") : b.bgColour),
              (l =
                b.bgOutline == "tag"
                  ? j(a.a, "color")
            ...
            b.outlineMethod == "size" &&
              (b.outlineIncrease > 0
                ? ((a.iw += 2 * b.outlineIncrease),
                  ...
                  (c = P(a.fimage, e, d)),
                  (a.oimage = c),
                  (a.fimage = G(a.fimage, a.oimage.width, a.oimage.height)))
                : ((e = g * (a.iw + 2 * b.outlineIncrease)),
                  (d = g * (a.ih + 2 * b.outlineIncrease)),
                  (c = P(a.fimage, e, d)),
                  (a.oimage = G(c, a.fimage.width, a.fimage.height)))))),
        a.Init();
    }
    function j(a, d) {
      var b = c.defaultView,
    ...
    function J(a, c) {
      var b,
        d,
        e = parseInt(j(c, "width")) / c.width,
        f = parseInt(j(c, "height")) / c.height;
      return (
        o(a.offsetX)
          ? (b = { x: a.offsetX, y: a.offsetY })
          : ((d = ah(c.id)),
            o(a.changedTouches) && (a = a.changedTouches[0]),
    ...
    function ad(e) {
      ...
      f &&
        c.tc[f] &&
        ((b = c.tc[f]),
        (d = J(e, b.canvas)) && ((b.mx = d.x), (b.my = d.y), b.Drag(e, d)),
        (b.drawn = 0));
    }
    function aq(b) {
      var e = a,
    ...
    function at(c) {
      ...
      b &&
        ...
        (c.touches.length == 1 && b.touchState == 0
          ? ((b.touchState = 1),
            b.BeginDrag(c),
            (d = J(c, b.canvas)) && ((b.mx = d.x), (b.my = d.y), (b.drawn = 0)))
    ...
    function aa(a, b) {
      (this.ts = null),
        ...
        this.colour == "tag"
          ? (this.colour = j(b.a, "color"))
          : this.colour == "tagbg" && (this.colour = j(b.a, "background-color")),
        (this.Draw = this.pulsate ? this.DrawPulsate : this.DrawSimple),
        (this.radius = a.outlineRadius | 0),
        this.SetMethod(a.outlineMethod);
    }
    (h = aa.prototype),
      (h.SetMethod = function (a) {
        var b = {
      ...
      (h.Update = function (d, e, i, j, a, f, g, h) {
      ...
      (h.DrawOutline = function (a, d, e, b, c, f) {
        var g = i(this.radius, c / 2, b / 2);
        (a.strokeStyle = f), this.Ants(a), v(a, d, e, b, c, g, !0);
      }),
      (h.DrawSize = function (i, n, m, l, k, j, a, h, g) {
        var f = a.w,
          e = a.h,
          c,
          b,
      ...
      (h.DrawColour = function (d, h, i, e, f, g, a, b, c) {
        return a.oimage
          ? (this.pulse < 1
      ...
      (h.DrawColourText = function (f, h, i, j, g, e, a, b, c) {
        var d = a.colour;
        return (a.colour = e), (a.alpha = 1), a.Draw(f, b, c), (a.colour = d), 1;
      }),
      (h.DrawColourImage = function (a, q, p, o, n, l, h, r, k) {
        var f = a.canvas,
          e = ~~g(q, 0),
          d = ~~g(p, 0),
          c = (i(f.width - e, o) + 0.5) | 0,
          b = (i(f.height - d, n) + 0.5) | 0,
          j;
        return (
          y ? ((y.width = c), (y.height = b)) : (y = m(c, b)),
          !y
            ? this.SetMethod("outline")
            : ((j = y.getContext("2d")),
              j.drawImage(f, e, d, c, b, 0, 0, c, b),
              a.clearRect(e, d, c, b),
              this.pulsate ? (h.alpha = 1 - w(this.pulse, 2)) : (h.alpha = 1),
              h.Draw(a, r, k),
              a.setTransform(1, 0, 0, 1, 0, 0),
              a.save(),
              a.beginPath(),
              ...
              (a.globalAlpha = 1),
              (a.globalCompositeOperation = "destination-over"),
              a.drawImage(y, 0, 0, c, b, e, d, c, b),
              (a.globalCompositeOperation = "source-over"),
              1)
        );
      }),
      (h.DrawBlock = function (a, d, e, b, c, f) {
        var g = i(this.radius, c / 2, b / 2);
        (a.fillStyle = f), v(a, d, e, b, c, g);
      }),
      (h.DrawSimple = function (a, b, c, d, e, f) {
        var g = this.tc;
        return (
          a.setTransform(1, 0, 0, 1, 0, 0),
      ...
      (h.DrawPulsate = function (h, d, e, f) {
        var g = p() - this.ts,
          c = this.tc,
          b =
            c.pulsateTo +
      ...
      (h.Active = function (d, a, b) {
        var c =
          a >= this.x &&
          b >= this.y &&
          a <= this.x + this.w &&
          b <= this.y + this.h;
        return c ? (this.ts = this.ts || p()) : (this.ts = null), c;
      }),
      (h.PreDraw = h.PostDraw = h.LastDraw = x);
    function M(a, h, c, b, e, f, g, d, i, j, k, l, m, n) {
      (this.tc = a),
        (this.image = null),
        (this.text = h),
        ...
        (this.a = c),
        (this.position = new u(b[0], b[1], b[2])),
    ...
    (d = M.prototype),
          ...
          a.txtOpt &&
            ...
            a.outlineMethod == "colour"
              ...
              : a.outlineMethod == "size" &&
                ...
                a.outlineIncrease > 0
                  ? (c = G(c, this.oimage.width, this.oimage.height))
                  : (this.oimage = G(this.oimage, c.width, c.height))),
            c &&
              ((this.fimage = c),
      ...
      (d.Weight = function (b, i, a, d, f, h, e) {
        ...
        "colour" == d
          ? (this.colour = H(a, c, e))
          : "bgcolour" == d
          ? (this.bgColour = H(a, c, e))
          : "bgoutline" == d
          ? (this.bgOutline = H(a, c, e))
          : "outline" == d
          ? (this.outline.colour = H(a, c, e))
          : "size" == d &&
      ...
      (d.Calc = function (g, e) {
        ...
        return (
          ...
          (this.xformed = a),
          (a = aB(b, a, b.stretchX, b.stretchY)),
          (this.x = a.x),
          (this.y = a.y),
          (this.z = a.z),
          (this.sc = a.w),
          (this.alpha = e * N(d + ((f - d) * (c - this.z)) / (2 * c), 0, 1)),
          this.xformed
        );
      }),
      ...
      (d.PlayAudio = function () {
        ...
        if (a) {
          ...
          return (
            (c.gain.value = i(2, g(0, this.tc.audioVolume * 1))),
            (a.currentTime = 0),
            (this.stopped = 0),
            (b = a.play()),
            b !== void 0 &&
    ...
    function a(f, m, j) {
      ...
      if (
        ...
        for (d = 0; d < l.length; ++d) h[l[d]] = b[l[d]];
        throw (b.parentNode.insertBefore(h, b), b.parentNode.removeChild(b), 0);
      }
      for (d in a.options)
        this[d] = j && o(j[d]) ? j[d] : o(a[d]) ? a[d] : a.options[d];
      if (
        ((this.canvas = b),
        (this.ctxt = b.getContext("2d")),
        (this.z1 = 250 / g(this.depth, 0.001)),
        (this.z2 = this.z1 / this.zoom),
        (this.radius = i(b.height, b.width) * 0.0075),
        (this.max_radius = 100),
        (this.max_weight = []),
        (this.min_weight = []),
        (this.textFont = this.textFont && S(this.textFont)),
        (this.textHeight *= 1),
        (this.imageRadius = this.imageRadius.toString()),
        (this.pulsateTo = N(this.pulsateTo, 0, 1)),
        (this.minBrightness = N(this.minBrightness, 0, 1)),
        (this.maxBrightness = N(this.maxBrightness, this.minBrightness, 1)),
        ...
        (this.fixedAlpha = 1),
        (this.source = m || f),
        (this.repeatTags = i(64, ~~this.repeatTags)),
        (this.minTags = i(200, ~~this.minTags)),
        ~~this.scrollPause > 0
        ...
        this.minTags > 0 &&
          ...
          (this.repeatTags = X(this.minTags / d) - 1),
        (this.transform = n.Identity()),
        (this.startTime = this.time = p()),
        (this.mx = this.my = -1),
        this.centreImage && az(this),
        ...
        (k[f] = [
          ...
          this.dragControl &&
            (k[f].push(["mousedown", aq]), k[f].push(["selectstart", x])),
          this.wheelZoom &&
            (k[f].push(["mousewheel", W]), k[f].push(["DOMMouseScroll", W])),
          this.scrollPause && k[f].push(["scroll", am, window]);
        for (d = 0; d < k[f].length; ++d)
          (h = k[f][d]), B(h[0], h[1], h[2] ? h[2] : b);
      }
      a.started ||
        ...
        (a.NextFrame = q ? a.NextFrameRAF : a.NextFrameTimeout),
    ...
    (b = a.prototype),
      ...
      (b.CreateTag = function (b) {
        ...
        if (
          ("image" != this.imageMode &&
            ...
            d.Empty()
              ? (d = null)
              : ((g = this.textFont || S(j(b, "font-family"))),
                this.splitWidth &&
                  (f = d.SplitWidth(
                    this.splitWidth,
                    this.ctxt,
                ...
                (h =
                  this.bgColour == "tag"
                    ? j(b, "background-color")
                    : this.bgColour),
                (i = this.bgOutline == "tag" ? j(b, "color") : this.bgOutline))),
          d || c)
        )
          return (
            (a = new M(
            ...
            c ? (a.SetImage(c), O(c, e[0], a, this)) : a.Init(),
            this.AddAudio(b, a),
            a
          );
      }),
      ...
      (b.Weight = function (d) {
        ...
        for (b = 0; b < f; ++b) {
          e[b] = [];
          for (a = 0; a < i; ++a)
            (c = al(d[b].a, h[a], this.textHeight)),
      ...
      (b.Load = function () {
        var c = this.GetTags(),
          ...
          a,
          e = [],
          m = { sphere: aE, vcylinder: aD, hcylinder: aC, vring: au, hring: aA };
        if (c.length) {
          e.length = c.length;
          for (a = 0; a < c.length; ++a) e[a] = a;
          this.shuffleTags && V(e),
            (h = 100 * this.radiusX),
            (i = 100 * this.radiusY),
            (j = 100 * this.radiusZ),
          ...
          for (a = 0; a < b.length; ++a)
            b[a].position = new u(f[a][0], f[a][1], f[a][2]);
        }
        this.noTagsMessage &&
          !b.length &&
          ((a =
      ...
      (b.Update = function () {
        ...
        if (e.length) {
          ...
          for (b = d.length / (f.length + 1), a = 0; f.length; )
            d.splice(X(++a * b), 0, this.CreateTag(e[f.shift()]));
          (this.shapeArgs[0] = g = d.length),
            (h = this.shape.apply(this, this.shapeArgs));
          for (a = 0; a < g; ++a)
            d[a].position = new u(h[a][0], h[a][1], h[a][2]);
      ...
      (b.LoadAudio = function () {
        ...
        (this.audio = c.createElement("audio")),
          ...
          (this.hasAudio = 1),
          (U = function (a) {
            e.resume(), c.removeEventListener("click", U);
          }),
      ...
      (b.ShowAudioIcon = function () {
        ...
        b || (b = e.state === l),
          this.audioIcon &&
            this.hasAudio &&
            (ag(b, d, a, k, f, g + 1, j ? i : h),
            ag(b, d, a, k, f, g, j ? h : i));
      }),
      ...
      (b.Wheel = function (a) {
        ...
        (this.zoom = i(this.zoomMax, g(this.zoomMin, b))), this.Zoom(this.zoom);
      }),
      (b.BeginDrag = function (a) {
        (this.down = J(a, this.canvas)),
          (a.cancelBubble = !0),
          (a.returnValue = !1),
    ...
    function ae(a) {
      var b = a.targetTouches[0],
        c = a.targetTouches[1];
      return F(w(c.pageX - b.pageX, 2) + w(c.pageY - b.pageY, 2));
    }
    (b.BeginPinch = function (a) {
      (this.pinched = [ae(a), this.zoom]), a.preventDefault && a.preventDefault();
    }),
      (b.Pinch = function (d) {
        var b,
          c,
        ...
        (c = ae(d)),
          (b = (a[1] * c) / a[0]),
          (this.zoom = i(this.zoomMax, g(this.zoomMin, b))),
          this.Zoom(this.zoom);
      }),
    ...
    (a.Linear = function (a, b) {
      ...
      (a.SetSpeed = function (c, b) {
        return (
          !!(C(b) && a.tc[c] && !isNaN(b[0]) && !isNaN(b[1])) &&
          (a.tc[c].SetSpeed(b), !0)
        );
      }),
      (a.TagToFront = function (c, b) {
        return !!C(b) && ((b.lat = b.lng = 0), a.RotateTag(c, b));
      }),
      ...
      (a.Delete = function (b) {
        ...
        if (k[b])
          if (((e = c.getElementById(b)), e))
            for (d = 0; d < k[b].length; ++d) aw(k[b][d][0], k[b][d][1], e);
        delete k[b], delete a.tc[b];
      }),
      (a.NextFrameRAF = function () {
        requestAnimationFrame(Y);
      }),
      (a.NextFrameTimeout = function (a) {
        setTimeout(ay, a);
      }),
      (a.tc = {}),
      (a.options = {
    ...
    for (s in a.options) a[s] = a.options[s];
    (window.TagCanvas = a),
      (jQuery.fn.tagcanvas = function (b, c) {
        var d = {
          pause: function () {
          ...
          update: function () {
            f(this).each(function () {
              t("Update", f(this)[0].id);
            });
          },
          tagtofront: function () {
            f(this).each(function () {
              a.TagToFront(f(this)[0].id, c);
            });
          },
          rotatetag: function () {
            f(this).each(function () {
              a.RotateTag(f(this)[0].id, c);
            });
          },
          delete: function () {
            f(this).each(function () {
              a.Delete(f(this)[0].id);
            });
          },
          setspeed: function () {
            f(this).each(function () {
              a.SetSpeed(f(this)[0].id, c);
            });
          }
        };
        return typeof b == "string" && d[b]
          ? (d[b].apply(this), this)
          : ((a.jquery = 1),
            f(this).each(function () {
              a.Start(f(this)[0].id, c, b);
            }),
            a.started);
      }),
      B(
